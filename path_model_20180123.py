...
x_expand = [[110, 160], [120, 170], [130, 220], [130, 210], [135, 250], [70, 160], [135, 320], [135, 365], [135, 360],
            [135, 425]]
y_expand = [[300, 400], [220, 350], [310, 390], [260, 350], [230, 340], [190, 340], [270, 340], [230, 330], [260, 330],
            [260, 330]]
ps = 3
...
print('date:', date_id)
wind = 13.5  # predicted wind speed larger than this value is thought to cause crash
rain = 3.2
...
x_bd0, x_bd1 = x_expand[ps]
y_bd0, y_bd1 = y_expand[ps]
print(x_bd0, x_bd1)
print(y_bd0, y_bd1)
...
def flyroute():
    try:
        ...
        def resultout():
            fout = open(r'C:\Bee\ProjectFile\WeatherFlyRouteSeason2\result0209_%d_%d_%d.csv' % (date_id, pn, t_st),
                        'ab')
